...
def get_command_line_parser():
    ...
    parser.add_argument('-backbone', type=str, default="resnet12",choices=['resnet18','resnet12'])
    ...
    parser.add_argument('-pretrain_accumulation_steps', type=int, default=1)

    parser.add_argument('-protonet_meta_mode', type=str, default="epoch",choices=["epoch", "task"])
    ...
    parser.add_argument('-protonet_task_num', type=int, default=1000)
    ...
    parser.add_argument('-increment_accumulation_steps', type=int, default=1)
    parser.add_argument('-num_enhance', type=int, default=10)
    ...
    parser.add_argument('-ablation_mode', type=str, default="ConCM", choices=['frozen','finetune','only_MPC','only_DSM_w_Aug','ConCM','ConCM_wo_AUG','only_DSM_wo_AUG'])

    parser.add_argument('-train_mpc_half', action='store_true', default=0)
    return parser
