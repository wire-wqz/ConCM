...
if __name__ == "__main__":
    ...
    dataroot = '/root/autodl-fs/dataset'
    batch_size_base = 128
    txt_path = "../../data/index_list/cifar100/session_2.txt"
    # class_index = open(txt_path).read().splitlines()
    class_index = np.arange(60)

    trainset = CIFAR100(root=dataroot, train=True, download=True, index=class_index, base_sess=True)
    ...
    #
    # trainset = CIFAR100(root=dataroot, train=True, download=True, transform=None, index=class_index,base_sess=True)
    # testset = CIFAR100(root=dataroot, train=False, download=False,index=class_index, base_sess=True)
